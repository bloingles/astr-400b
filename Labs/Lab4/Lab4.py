...
def hernquist_mass(r:u.Quantity,h_a:u.Quantity=60*u.kpc, m_halo:float=1.975) -> u.Quantity: # ADD m_halo=??
...
def jacobi_mass(rj:u.Quantity,r:u.Quantity,m_host:u.Quantity) -> u.Quantity:
...
def main() -> None:
    ...
    # minimum mass of the LMC needed to maintain a size of 18.5 kpc
