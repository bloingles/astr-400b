...
from Lab13_Template import CosmologicalTools
...
def main() -> None:
    ...
    # 
    # 
    # In this exercise we will use data from the Supernova Cosmology
    # project, one of the two teams which first found that the
    # expansion rate of the Universe is accelerating in 1999. A simple
    # introduction to the methods and findings of the SCP group can be
    # found at
    # https://newscenter.lbl.gov/2009/10/27/evolving-dark-energy/. The
    # original paper is Perlmutter *et al.* 1999, "Measurement of
    # $\Omega$ and $\Lambda$ from 42 High Redshift Supernovae", The
    # Astrophysical Journal, Vol. 517, page 565.
    # 
    # The data set we will be using is a more recent sample,
    # containing observations of 580 supernovae, known as the Union
    # 2.1 sample from the paper Suzuki *et al*. 2012, "THE *HUBBLE
    # SPACE TELESCOPE* CLUSTER SUPERNOVA SURVEY. V. IMPROVING THE
    # DARK-ENERGY CONSTRAINTS ABOVE $z>1$ AND BUILDING AN
    # EARLY-TYPE-HOSTED SUPERNOVA SAMPLE", The Astrophysical Journal,
    # vol. 746, page 85.
    # 
    ...
    # plot here
    ax.plot(data['z'],data['DistMod'],'b.',label='SNeData')
    ...
    legend = ax.legend(loc='upper left',fontsize=18)
    fig.savefig('LumDistvsRecSpeed.png')
    ...
    fig.savefig('Model-LumDistvsRecSpeed.png')
    ...
    ax.plot(VR,modelLD,'r',label='VR/Ho')
    ...
    fig.savefig('All-LumDistvsRecSpeed.png')
