...
def main() -> None:    
    ...
    DeSitter = CosmologicalTools(OmegaMD,OmegaRD,OmegaLD,h_planck)# In[ ]:
    ...
    HubbleBenchmarkz1 = BenchMark.LookBackTime(1)
    print(HubbleBenchmarkz1)

    # Question 1 B) 

    # What is the Age of the Universe in the Benchmark Cosmology  (put in a large z)

    HubbleBenchmarkz1000 = BenchMark.LookBackTime(1000)
    print(HubbleBenchmarkz1000)


    # What is the Age of the Universe in the Einstein De Sitter Cosmology


    HubbleDeSitterz1000 = DeSitter.LookBackTime(1000)
    print(HubbleDeSitterz1000)
