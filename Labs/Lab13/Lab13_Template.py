...
def main() -> None:
    ...
    print(f'{Theta*u.radian.to(u.degree)}°')

    print(1/(70*u.km/u.s/u.Mpc).to(1/u.Gyr))
    ...
    # What is the size of sound horizon at the epoch of recombination
    # in the Desitter Cosmology? 

    SoundHorizonED = DeSitter.SoundHorizon(z_recombine,20000)
    print(SoundHorizonED)

    # What is the sound horizon TODAY in the DeSitter Cosmology?
    ...
    print(f'{ThetaSound*u.radian.to(u.degree)}°')
