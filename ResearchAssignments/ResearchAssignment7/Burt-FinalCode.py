...
def majorAnnuli(
    ...
    # This is an optimized list I am using as a compromise, since the
    # numpy array restriction is difficult to implement for a list
    # that does not have a known initial size.
    ...
    while i < N:
        ...
        # I have approval to use this append
        # Note that it is appending a deque, not a list
        i = last
